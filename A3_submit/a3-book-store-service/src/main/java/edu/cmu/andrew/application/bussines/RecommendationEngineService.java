...
* 
*  Service layer that controls the execution and invocation of the service recommendation engine, it also manages the circuit breaker status
*  
...
public class RecommendationEngineService {
	...
	/**
	 * Method that invokes the recommendation engine, note that is protected by a fallback method called "fallback" in case the engine service is unavailable
	...
	/**
	 * This is a fallback method that will execute only if the recommendation engine service is unavailable or it produces a timeout
